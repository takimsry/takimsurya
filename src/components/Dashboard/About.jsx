          ...
          <div className="about__content-main" data-aos="fade-up" data-aos-delay="150">
            ...
            <div className="about__content-details">
              <p className="about__content-details-para">
                Welcome! I'm a passionate <strong>Full Stack Developer</strong> specializing in Front-End Development using <strong>React.js</strong> and Back-End Development using <strong>Node.js</strong>, <strong>Express.js</strong>, <strong>Hapi.js</strong>, and <strong>CodeIgniter PHP</strong>. With a strong background and ongoing studies in Computer Science, I constantly push the boundaries of what's possible.
              </p>
              <p className="about__content-details-para">
            ...
            <a href="https://drive.google.com/file/d/1PW-Xj2y29IqPbh3fFgz3I5tG8RbE8FoI/view?usp=sharing" className="btn btn--med btn--theme dynamicBgClr" target="_blank" rel="noreferrer"
              >My CV</a
            >
          </div>
